...
/**
 * Reservation Updated Trigger
 *
 * Configures the email trigger for when a reservation is updated (excluding status changes).
 *
 * @package WpCafe/Reservation/Email/Triggers
 */
class Reservation_Updated_Trigger extends Abstract_Trigger {
	...
	public function get_trigger_label() {
		return __( 'Reservation Updated', 'wp-cafe' );
	}
