(function( $ ) {
	...
	$(document.body).on('click', '.cf7cstmzr-settings-save', function() {
		...
		var data = {
			...
			nonce:  cf7cstmzr_ajax_object.save_form_customizer_settings_nonce,
			formData: formData
		};
	...
	$(document.body).on('change', '#cf7cstmzr-load-body-tag', function() {
		...
		var data = {
			...
			nonce:  cf7cstmzr_ajax_object.load_body_tag_nonce,
			loadBody: loadBody,
		}
	...
	$(document.body).on('click', '#cf7cstmzr-enable-globally', function() {
		...
		$.ajax({
			...
			data: {
				...
				nonce:  cf7cstmzr_ajax_object.enable_globally_nonce,
				scheme: scheme
			},
			success: function (response) {
				var decoded;
	...
	$(document.body).on('click', '#cf7cstmzr-disable-globally', function() {
		...
		$.ajax({
			...
			data: {
				...
				nonce:  cf7cstmzr_ajax_object.disable_globally_nonce,
			},
			success: function (response) {
				var decoded;
	...
	$(document.body).on('click', '#cf7cstmzr-enable-for-form', function() {
		...
		$.ajax({
			...
			data: {
				...
				nonce:  cf7cstmzr_ajax_object.enable_for_form_nonce,
				scheme: scheme,
				form: form,
			},
			success: function (response) {
	...
	$(document.body).on('click', '#cf7cstmzr-disable-for-form', function() {
		...
		$.ajax({
			...
			data: {
				...
				nonce:  cf7cstmzr_ajax_object.disable_for_form_nonce,
				form: form,
			},
			success: function (response) {
				var decoded;
	...
	$(document.body).on('click', '#cf7cstmzr-settings-create', function() {
		...
		$.ajax({
			...
			data: {
				...
				nonce:  cf7cstmzr_ajax_object.new_form_customizer_settings_nonce,
				formData: formData,
	...
	$(document.body).on('click', '#cf7cstmzr-settings-delete', function() {
		...
		var data = {
			...
			nonce:  cf7cstmzr_ajax_object.delete_form_customizer_settings_nonce,
			scheme: scheme,
			isFw: isFw
		};
	...
	$(document.body).on('click', '.go-to-upgrade', function(e) {
		...
		if (saveButton.hasClass('button-success')) {
			if (confirm(confirmMessage)) {
				...
				var data = {
					action: 'cf7cstmzr_save_form_customizer_settings',
					nonce:  cf7cstmzr_ajax_object.save_form_customizer_settings,
					formData: formData
				};
